...
class AcquisitionController:
    ...
    def start_acquisition(self, trigger_check_decimation: int = 20, time_between_points: float = 30.0, total_duration_minutes: float = None, restart_scan_each_trigger: bool = True, check_buffer_every: int = 0):
        ...
        Args:
            ...
            restart_scan_each_trigger: If True, stop and restart scan after each trigger (default: True)
            check_buffer_every: If >0, check buffer usage every N cycles and restart scan if buffer usage >90% (default: 0 = disabled)
        """
